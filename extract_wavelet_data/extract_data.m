src_dir_path = "test_txt";
dst_dir_path = "test_data";
...
for i = 1:files_count
    ...
    scales = scalerange(end):10:scalerange(1);       % число рассматриваемых масштабов, вместо 1 можно например 10 поставить чтобы быстрее считалось, это по сути шаг, рассматривать будет каждый 10 масштаб тогда
